...
def save_img(img_path, detections, classes, output_dir, name, opt):
    ...
    if detections is not None:
        ...
        bbox_colors = [colors[int(l.item())] for l in unique_labels]
        for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
            ...
            ax.add_patch(bbox)
            # Add label
            plt.text(x1+box_w, y1+box_h, s=classes[int(cls_pred)], color='white', verticalalignment='top',
                    bbox={'color': color, 'pad': 0}, fontsize=6)
